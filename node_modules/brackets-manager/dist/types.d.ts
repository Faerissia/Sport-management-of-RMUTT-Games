 ...
 */
export declare type OrderingMap = Record<SeedOrdering, <T>(array: T[], ...args: number[]) => T[]>;
/**
 ...
 */
export declare type Duel = [ParticipantSlot, ParticipantSlot];
/**
 * The side of an opponent.
 */
export declare type Side = 'opponent1' | 'opponent2';
/**
 ...
 */
export declare type ChildCountLevel = 'stage' | 'group' | 'round' | 'match';
/**
 ...
 */
export declare type BracketKind = 'single_bracket' | 'winner_bracket' | 'loser_bracket' | 'final_group';
/**
 * Positional information about a round.
 */
export declare type RoundPositionalInfo = {
    roundNumber: number;
    roundCount: number;
};
/**
 ...
 */
export declare type Table = keyof DataTypes;
/**
 * Format of the data in a database.
 */
export declare type Database = ValueToArray<DataTypes>;
/**
