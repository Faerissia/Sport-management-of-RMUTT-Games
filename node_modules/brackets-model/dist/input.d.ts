 ...
 */
export declare type CustomParticipant<ExtraFields = Record<string, unknown>> = Participant & ExtraFields;
/**
 ...
 * - Or a BYE: `null`.
 */
export declare type Seeding = (CustomParticipant | string | number | null)[];
/**
