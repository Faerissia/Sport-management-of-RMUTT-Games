...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2023 at 09:52 PM
...
(17, 'wasawin.14@gmail.com', 'testtest', 'วสวิญญ์', 'รัตน์โชติ', '0937576149', 'ผู้ดูแลระบบ', 'ใช้งาน');
...
(861, 385, 405, NULL, NULL, NULL, NULL, NULL, 72, '1', 1, NULL, NULL, NULL, NULL, NULL);
...
(69, 'แบดมินตัน ประเภทเดี่ยว 8 คน', 1, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-03-20', '2023-03-22', '2023-03-23', '2023-03-25', 'single', 'แบดมินตัน ประเภทเดี่ยว 6 คน รูปแบบการแข่งขัน แพ้คัดออก', '1679521706553_à¹à¸à¸à¸à¸´à¸à¹à¸à¹à¸à¸à¸²à¸£à¹à¸¥à¹à¸à¹à¸à¸à¸¡à¸´à¸à¸à¸±à¸_1.jpg', '1679521706557_à¹à¸à¸à¸à¸´à¸à¹à¸à¹à¸à¸à¸²à¸£à¹à¸¥à¹à¸à¹à¸à¸à¸¡à¸´à¸à¸à¸±à¸_1.jpg', NULL, '97', NULL, NULL),
(70, 'วอลเลย์บอล หญิง', 3, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-03-22', '2023-03-25', '2023-03-26', '2023-03-28', NULL, 'วอลเลย์บอล หญิง', '1679547009594_5a0ef0d.jpg', '1679547009605_5a0ef0d.jpg', NULL, '97', NULL, NULL),
(71, 'บาสเกตบอล ชาย', 4, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-03-22', '2023-03-24', '2023-03-25', '2023-03-27', NULL, 'บาสเกตบอล ชาย', '1679547379650_basketball.jpg', '1679547379656_basketball.jpg', NULL, '97', NULL, NULL),
(72, 'เปตอง หญิงเดี่ยว', 5, 'บัตรประจำตัวนักศึกษา', '2023-03-22', '2023-04-24', '2023-04-25', '2023-04-27', 'single', 'เปตอง หญิงเดี่ยว', '1679550350661_kl.jpg', '1679550350665_kl.jpg', NULL, NULL, NULL, NULL),
...
(81, 'การแข่งขันที่ 1', 5, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-04-01', '2023-04-10', '2023-04-11', '2023-04-16', NULL, 'เป็นการทดสอบระบบ', '1680388270994_5.jpg', '1680388270995_5.jpg', NULL, NULL, NULL, NULL),
(82, 'การแข่งขันที่ 2', 5, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-04-01', '2023-04-04', '2023-04-05', '2023-04-17', NULL, 'เป็นการทดสอบระบบ', '1680388270994_5.jpg', '1680388270995_5.jpg', NULL, NULL, NULL, NULL),
(83, 'testw8_01', 4, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-03-01', '2023-04-10', '2023-04-11', '2023-04-16', NULL, 'testw8', '1680760890147_images.jpg', '1680760890148_images.jpg', NULL, NULL, NULL, NULL),
(84, 'test02', 3, 'บัตรประชาชน', '2023-04-01', '2023-04-12', '2023-04-13', '2023-04-30', NULL, 'tes', '1680771373731_images.jpg', '1680771373732_images.jpg', NULL, NULL, NULL, NULL),
(85, 'test03', 4, 'บัตรประชาชน', '2023-04-01', '2023-04-05', '2023-04-06', '2023-04-20', NULL, 'tes', '1680771415833_images.jpg', '1680771415833_images.jpg', NULL, NULL, NULL, NULL),
(86, 'การแข่งขันที่ 333', 5, 'บัตรประชาชน และ บัตรประจำตัวนักศึกษา', '2023-04-01', '2023-04-04', '2023-04-05', '2023-04-16', NULL, 'เป็นการทดสอบระบบ', '1680388270994_5.jpg', '1680388270995_5.jpg', NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `account`
  MODIFY `accountID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `highlight`
  MODIFY `highlightID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `matchplay`
--
ALTER TABLE `matchplay`
  MODIFY `matchID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=862;
...
--
ALTER TABLE `tournament`
  MODIFY `tnmID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
